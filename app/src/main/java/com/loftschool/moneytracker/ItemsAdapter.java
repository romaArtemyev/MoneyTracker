...
public class ItemsAdapter extends RecyclerView.Adapter<ItemsAdapter.ItemsViewHolder>{
    ...
    static class ItemsViewHolder extends RecyclerView.ViewHolder {
        ...
        private void bind(final Item item, final int pos, boolean selected, final ItemsAdapterListener listener) {
            ...
            spannable.setSpan(new AbsoluteSizeSpan(context.getResources().getDimensionPixelSize(R.dimen.rouble_size)), string.length()-1, string.length(), Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);            price.setText(spannable);
